...
unet.eval()
unet.to(device)
unet.load_state_dict(torch.load('adlcv_ex_5/weights/DDPM/model.pth', map_location=device))
...
show(imgs, fig_titles=CLASS_LABELS, title='Classifier Guidance', save_path='adlcv_ex_5/assets/cg_samples.png')
